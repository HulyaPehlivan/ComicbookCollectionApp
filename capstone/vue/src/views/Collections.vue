...
export default {
  ...
  methods: {
    ...
    setActiveId() {
      this.$route.params.collectionId = this.$store.state.activeCollectionId;
    },
  },
};
</script>
